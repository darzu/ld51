import { mkRenderable, legacyCodeTree } from "./legacy-block-ast.js";
...
// Sample
// ========================================
export let codeTree_tri_sizing = [
    {
        kind: "stmt",
        corner: "triangular",
...
export let world = document.getElementById("world");
// WORD WRAP BAR
// ========================================
let wwMaxWidth = 600;
var ww;
(function (ww) {
    ...
    let wwPath = (x) => `m ${x},${W * 2} q 0,-${W} ${W},-${W} q ${W},0 ${W},${W} v ${H} q 0,${W} -${W},${W} q -${W},0 -${W},-${W} Z`;
...
//# sourceMappingURL=blocks_main.js.map