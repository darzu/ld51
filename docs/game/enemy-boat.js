...
export const { EnemyShipPropsDef, EnemyShipLocalDef, createEnemyShip } = defineNetEntityHelper(EM, {
    name: "enemyShip",
    defaultProps: (loc, speed, wheelSpeed, wheelDir, parent) => {
        return {
...
export function spawnEnemyShip(loc, parentId, wheelDir, facingRight) {
...
//# sourceMappingURL=enemy-boat.js.map