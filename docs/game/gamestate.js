...
import { createPlayerShip, PlayerShipLocalDef, PlayerShipPropsDef, } from "./player-ship.js";
...
export const startGame = eventWizard("start-game", () => [[PlayerDef]], () => {
...
export const restartGame = eventWizard("restart-game", () => [[PlayerShipPropsDef]], ([ship]) => {
    console.log("restart");
    ...
    legalEvent: () => EM.getResource(GameStateDef).state === GameState.GAMEOVER,
});
export function registerGameStateSystems(em) {
    em.registerSystem(null, [GameStateDef, TimeDef, HostDef], ([], res) => {
