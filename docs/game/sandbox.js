...
export function initDbgGame(em, hosting) {
    ...
    em.registerOneShotSystem(null, [AssetsDef, GlobalCursor3dDef, RendererDef], (_, res) => {
        ...
        function createWorldShape(g, world, pos, lastWorldPos) {
        ...
        em.registerSystem(null, [InputsDef], (_, { inputs }) => {
            ...
            // TODO(@darzu):
            const shapeA = createWorldShape(res.assets.cube, b1.world, b1.position, lastWorldPos[0]);
            const shapeB = createWorldShape(res.assets.cube, b2.world, b2.position, lastWorldPos[1]);
            const shapeC = createWorldShape(res.assets.ball, b3.world, b3.position, lastWorldPos[2]);
            const shapeD = createWorldShape(res.assets.tetra, b4.world, b4.position, lastWorldPos[3]);
