...
import { copyFrame, PositionDef, ScaleDef, updateFrameFromPosRotScale, } from "./transform.js";
...
export function registerPhysicsDebuggerSystem(em) {
    ...
    em.registerSystem([DbgMeshDef, PositionDef, ScaleDef, WorldFrameDef], [], (es, res) => {
        for (let e of es) {
