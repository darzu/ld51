import { align, bytesPerMat4, bytesPerVec3 } from "./main.js";
...
const shaderSceneStruct = `
  ...
  `;
const texVertShader = shaderSceneStruct +
    `
...
const fragmentShader = shaderSceneStruct +
  ...
  `;
export function createTextureRBundle(device, texFormat) {
    // defines the format of our scene's uniform data
    const texUniBufSizeExact = bytesPerMat4 * 2 + // camera and light projection
...
//# sourceMappingURL=tex-render.js.map