...
export function mergeMeshes(rs) {
    ...
    for (let r of rs) {
        ...
        m.tri = [
            ...m.tri,
            ...r.tri.map((t) => [t[0] + posIdx, t[1] + posIdx, t[2] + posIdx]),
        ];
        m.quad = [
            ...m.quad,
            ...r.quad.map((t) => [t[0] + posIdx, t[1] + posIdx, t[2] + posIdx, t[3] + posIdx]),
        ];
        if (m.lines)
            m.lines = [
                ...m.lines,
                ...r.lines.map((t) => [t[0] + posIdx, t[1] + posIdx]),
            ];
