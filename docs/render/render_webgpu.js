...
import { createMeshPool_WebGPU, SceneUniform, Vertex, } from "./mesh-pool.js";
import { MeshUniformMod, obj_fragShader, obj_vertShader, } from "./shader_obj.js";
...
export class Renderer_WebGPU {
    constructor(canvas, device, context, adapter, maxMeshes, maxVertices) {
        this.drawLines = true;
        this.drawTris = true;
        this.backgroundColor = [0.6, 0.63, 0.6];
    ...
    */
    addMesh(m) {
        const handle = this.pool.addMesh(m);
