...
import { getAABBFromMesh } from "../mesh.js";
import { GPUBufferUsage } from "../webgpu-hacks.js";
import { sceneBufPtr, litTexturePtr, mainDepthTex, surfacesTexturePtr, } from "./std-scene.js";
...
export const OceanVertStruct = createCyStruct({
    ...
    isCompact: true,
    serializer: ({ position, color, normal, tangent, uv, surfaceId }, _, offsets_32, views) => {
...
export function computeOceanUniData(m) {
    // TODO(@darzu): change
