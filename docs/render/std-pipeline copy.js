...
import { mainDepthTex, canvasTexturePtr, litTexturePtr, meshPoolPtr, normalsTexturePtr, positionsTexturePtr, sceneBufPtr, surfacesTexturePtr, } from "./std-scene.js";
...
export const { pipeline: normalDbg } = createRenderTextureToQuad("normalDbg", normalsTexturePtr, 0.2, 0.8, 0.2, 0.8);
export const { pipeline: positionDbg } = createRenderTextureToQuad("positionDbg", positionsTexturePtr, 0.2, 0.8, -0.8, -0.2);
...
//# sourceMappingURL=std-pipeline%20copy.js.map