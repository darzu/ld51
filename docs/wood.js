...
import { BLACK, mkTimberSplinterFree, } from "./game/assets.js";
...
import { centroid, quatFromUpForward, randNormalVec3, } from "./utils-3d.js";
        ...
        for (let w of es) {
            ...
            if (hits) {
                ...
                for (let ball of balls) {
                    ...
                    assert((ball === null || ball === void 0 ? void 0 : ball.collider.shape) === "AABB");
