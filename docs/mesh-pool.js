...
export const MeshHandleDef = EM.defineComponent("meshHandle", (h) => {
    return h;
});
...
function createMeshPoolBuilder(opts, maps, queues) {
    ...
    function queueUpdateMesh(h, m) {
        ...
        if ((_b = h.numLines !== ((_a = m.lines) === null || _a === void 0 ? void 0 : _a.length)) !== null && _b !== void 0 ? _b : 0)
        ...
        const b = createMeshBuilder(data, 0, 0, 0, 0, opts.shiftMeshIndices ? h.vertNumOffset : undefined);
        m.pos.forEach((pos, i) => {
            b.addVertex(pos, DEFAULT_VERT_COLOR, [1.0, 0.0, 0.0]);
        });
        m.tri.forEach((triInd, i) => {
