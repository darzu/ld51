...
import { initClothSandbox, initGJKSandbox, initReboundSandbox, } from "./game/game-sandbox.js";
...
function callFixedTimestepSystems() {
    ...
    if (GAME === "gjk") {
        ...
        if (EM.hasSystem("checkGJK"))
            EM.callSystem("checkGJK");
    }
