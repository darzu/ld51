...
export function FRGBToFLRGB({ fr, fg, fb }) {
...
export function FLRGBToFRGB({ flr, flg, flb }) {
...
export function FLRGBToXYZD65(rgb) {
...
export function XYZD65ToFLRGB(xyz) {
...
// Lab and LCH
export function XYZD50_to_CIELAB(XYZ) {
...
export function Lab_to_XYZD50(lab) {
    const Lab = toV3(lab);
...
export function Lab_to_LCH(cielab) {
